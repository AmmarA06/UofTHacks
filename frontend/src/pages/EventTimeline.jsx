...
function EventCard({ event, index }) {
  ...
  return (
    ...
    >
      ...
      {/* Event content */}
      <div className="ml-4 p-4 rounded-2xl border border-gray-300 bg-white hover:border-gray-400 transition-colors shadow-md">
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-start gap-3">
            <div className="w-9 h-9 bg-gray-100 rounded-xl flex items-center justify-center text-[#1a1a1a]">
              <Icon size={18} />
            </div>
            <div>
              <h4 className="font-semibold text-[#1a1a1a] text-[14px]">{config.label}</h4>
    ...
    <PageTransition>
      <div className="space-y-8 py-8">
        ...
        <motion.div variants={fadeInUp} className="flex items-start justify-between">
          <div>
            <h1 className="text-[32px] font-semibold tracking-tight text-[#1a1a1a]">
              Event Timeline
            </h1>
        ...
        <div className="bg-white rounded-2xl border border-gray-300 overflow-hidden shadow-lg">
          <div className="p-5 border-b border-gray-100 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-[16px] font-semibold text-[#1a1a1a]">Event Feed</h3>
            </div>
          ...
          <div className="p-6">
            {loading && events.length === 0 ? (
              ...
              <div className="text-center py-12 text-red-500">
                ...
                <button
                  onClick={refetch}
                  className="mt-4 px-5 py-2.5 bg-[#1a1a1a] text-white rounded-full text-[13px] hover:bg-black transition-colors"
                >
                  Retry
                </button>
              </div>
        ...
        {/* Event Legend */}
        <div className="bg-white rounded-2xl border border-gray-300 p-6 shadow-lg">
          <h3 className="text-[16px] font-semibold text-[#1a1a1a] mb-4">Event Types</h3>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="font-semibold text-[#1a1a1a] text-[13px]">{config.label}</span>
                  </div>
